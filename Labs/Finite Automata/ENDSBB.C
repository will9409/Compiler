...
char alphabet[NO_OF_ALPHABET] = { 'a', 'b','c' };	// symbol must be char constant

char starting_state = 0;
int accepting_states[NO_OF_STATES] = { 0,0,1 };	// 1 means accepting state

char transition_function[NO_OF_STATES][NO_OF_ALPHABET] = {
  {0, 1, 0},
  {0, 2, 0},
  {0, 2, 0}
};
